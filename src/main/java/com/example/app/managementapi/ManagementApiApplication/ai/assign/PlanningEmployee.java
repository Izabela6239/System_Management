...
public class PlanningEmployee {
    ...
    public int getCapacityMinPerDay() {
        return capacityMinPerDay;
    }

    public void setCapacityMinPerDay(int capacityMinPerDay) {
        this.capacityMinPerDay = capacityMinPerDay;
    }

    public Set<LocalDate> getLeaves() {
        return leaves;
    }

    public void setLeaves(Set<LocalDate> leaves) {
        this.leaves = leaves;
    }
